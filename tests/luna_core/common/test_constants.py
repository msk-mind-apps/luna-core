...
def test_source_table_name():
    c1 = ConfigSet(name=const.DATA_CFG, config_file='tests/luna_core/common/testdata/geojson_data.yaml')

    assert const.TABLE_NAME(c1, is_source=True) == "REGIONAL_BITMASK_dsn"

def test_table_name():
    c1 = ConfigSet(name=const.DATA_CFG, config_file='tests/luna_core/common/testdata/data_ingestion_template_valid.yml')
...
def test_table_location_emptystring():
    c1 = ConfigSet(name=const.DATA_CFG, config_file='tests/luna_core/common/testdata/data_ingestion_template_valid_empty_dataset.yml')
...
def test_table_location_none():
    c1 = ConfigSet(name=const.DATA_CFG, config_file='tests/luna_core/common/testdata/data_ingestion_template_valid_empty_dataset_2.yml')
